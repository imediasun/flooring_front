...
/**
 * Generated from protobuf message <code>openapi.v3.CallbackOrReference</code>
 */
class CallbackOrReference extends \Google\Protobuf\Internal\Message
{
    protected $oneof;
     ...
     *
     *     @type \Openapi\V3\Callback $callback
    ...
    /**
     * Generated from protobuf field <code>.openapi.v3.Callback callback = 1;</code>
     * @return \Openapi\V3\Callback|null
     */
    ...
    /**
     * Generated from protobuf field <code>.openapi.v3.Callback callback = 1;</code>
     * @param \Openapi\V3\Callback $var
     * @return $this
     */
    public function setCallback($var)
    {
        GPBUtil::checkMessage($var, \Openapi\V3\Callback::class);
